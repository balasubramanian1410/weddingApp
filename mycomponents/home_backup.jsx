...
const Home = React.createClass({
			...
			<div className="col-xs-12 centerDes">
				...
				<div className="col-xs-12">
					<div className="couple-name col-xs-12 padd0 displayFlex alignItemsCenter">
					  <div className='floatLeft positionNames wow zoomIn' data-wow-delay="0.4s">
				...
				<div className="col-xs-12 wow zoomIn displayFlex">
					<div className='marginAuto'>
						<div className="line col-xs-4 wow bounceInLeft" data-wow-delay="0.7s" data-wow-duration="2s"></div>
						<div className="date col-xs-4 wow zoomIn" data-wow-delay="0.5s">{config.marriageDate}</div>
			...
			<ul className="timeline wow slideInUp" data-wow-duration="3s">
				...
				return(
					<li className="wow bounceInLeft"  data-wow-duration="2s">
						...
						<div className="timeline-panel wow bounceInLeft">
    ...
    <section id="People" className="services-section">
		...
		<div className="col-xs-12">
			...
			<div className="col-xs-6" onClick={this.handleImgClick}>
				<div className="slider-for1 wow bounceInLeft col-xs-12">
				  ...
				  return(
						<FlipCard>
						  ...
						  <div className="bigPic" onClick={this.handleImgClick}>
							  <div className="peopleDetails">
								  <div className="peopleDetailsContainer">
								  <div className='marginAuto alignVerticalCenter'>
    ...
    <section id="events" className="services-section">
		...
		<div className="col-xs-12 eventHeight">
			<h2 className="coupleTitle allignLoveline wow zoomIn">Events</h2>
			<div className="event-tabs">
				<div className="event-title wow bounceInRight" data-wow-delay="0.1s">
					<div className="title style3">
						<h4>Event <br/> <span>Schedule</span></h4>
					</div>
					<ul className="nav navbar-nav eventsList">
						<li className="active"><a data-toggle="tab" href="#event-tab1"><i className="fa fa-diamond"></i> Wedding Ceremony</a></li>
						<li className=""><a data-toggle="tab" href="#event-tab2"><i className="fa fa-spoon"></i> Reception Ceremony</a></li>
					</ul>
					<a href="#" title="">RSVP</a>
				</div>
				<div className="tab-content">
					...
					<div className="event-schedule">
						<div className="event-venue wow bounceInRight" data-wow-delay="0.2s">
							<div className="ti1">
								<h4>Venue</h4>
							</div>
							...
							<ul className="event-address">
								<li><i className="fa fa-home"></i> <strong>Address:</strong><span>{config.wedAddress}</span><span><img className="locationImg wow bounce" data-wow-delay="1s" src="./images/map-marker-13.png"/></span></li>
								<li><i className="fa fa-phone"></i> <strong>Phone:</strong>{config.wedPhone}</li>
								<li><i className="fa fa-envelope"></i> <strong>Email:</strong> <a href="#" title="">{config.wedEmail}</a></li>
							</ul>
						</div>
						<div className="ceremony-details wow bounceInRight" data-wow-delay="0.3s">
							<div className="ti1">
							...
							<div className="cerevent-detail">
								<div className="event-detail-inner">
									...
									<div className="event-play">
										<span className="inner-title">Song Playlist:</span>
										<ul>
											<li>
												<img src="./images/play1.jpg" alt=""/>
												<a href="#" title="">Wedding song album</a>
											</li>
										</ul>
									</div>
								</div>
					...
					<div className="event-schedule">
						<div className="event-venue wow bounceInRight" data-wow-delay="0.2s">
							...
							<ul className="event-address">
								<li><i className="fa fa-home"></i> <strong>Address:</strong><span>{config.recAddress}</span><span><img className="locationImg second wow bounce" data-wow-delay="1s" src="./images/map-marker-13.png"/></span></li>
								<li><i className="fa fa-phone"></i> <strong>Phone:</strong>{config.recPhone}</li>
								<li><i className="fa fa-envelope"></i> <strong>Email:</strong> <a href="#" title="">{config.recEmail}</a></li>
							</ul>
						</div>
						<div className="ceremony-details wow bounceInRight" data-wow-delay="0.3s">
							<div className="ti1">
							...
							<div className="cerevent-detail">
								<div className="event-detail-inner">
									...
									<div className="event-play">
										...
										<ul>
											<li>
												<img src="./images/resource/play1.jpg" alt=""/>
												<a href="#" title="">Wedding song album</a>
											</li>
										</ul>
									</div>
	...
	<section id="rsvp" className="services-section bg-light-gray">
        
		<div className="col-xs-12 rsvp">
			...
			<section id='saveData' className="saveHeight">
			...
			<div className="col-xs-12 topDiv"><div className="col-xs-12 applyParallax makeContrast"></div></div>
			<div className="col-xs-12 centerDes">
				<div className="col-xs-12 textMarry wow zoomIn" data-wow-delay="0.1s">Thank you</div>
				<div className="col-xs-12 textMarry wow zoomIn" data-wow-delay="0.2s">Save the date</div>
				<div className="col-xs-12 mtopN19 saveNames">
					<div className="couple-name col-xs-12 allignCenter">
					  <h1 className="broomName wow bounceInLeft col-xs-4" data-wow-delay="0.6s" data-wow-duration="2s">{config.groomName}</h1>
					  <h1 className="broomName wow  zoomIn col-xs-4 ambursent" data-wow-delay="0.3s">&</h1>
					  <h1 className="col-xs-4 brideName wow bounceInRight" data-wow-delay="0.6s" data-wow-duration="2s">{config.brideName}</h1>
					</div>
				</div>
				<div className="col-xs-12 dateAlling">
				<div className="line col-xs-4 wow bounceInLeft" data-wow-delay="0.6s" data-wow-duration="2s"></div>
				<div className="date col-xs-4 wow zoomIn" data-wow-delay="0.3s">{config.marriageDate}</div>
				<div className="line col-xs-4 wow bounceInRight" data-wow-delay="0.6s" data-wow-duration="2s"></div>
				</div>
				<div className="col-xs-12 decor decor-inverse topDecorBot wow zoomIn" data-wow-delay="0.5s">
				<svg dangerouslySetInnerHTML={{__html: useTag }} width="281px" height="51px" viewBox="0 0 281 51">
				</svg>
				</div>
