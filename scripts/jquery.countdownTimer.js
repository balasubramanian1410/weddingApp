...
(function ($) {
    ...
    function givenDate($this, opts, type) {
        ...
        if ((endDate - startDate) > 0) {
			...
			$('.countdown > li:nth-child(1) > span').html(days);
			$('.countdown > li:nth-child(2) > span').html(hours);
			$('.countdown > li:nth-child(3) > span').html(minutes);
			$('.countdown > li:nth-child(4) > span').html(seconds);
